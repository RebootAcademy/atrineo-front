...
// Modificado para controlar su estado de apertura y cierre
const DropdownMenu = ({ isOpen, onOpenChange, children }) => {
  return (
...
const DropdownMenuContent = React.forwardRef(({ className, sideOffset = 20, ...props }, ref) => (
