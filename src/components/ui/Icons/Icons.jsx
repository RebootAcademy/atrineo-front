export const LayersIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_1156_10110)">
      <path d="M1.33398 11.3333L8.00065 14.6666L14.6673 11.3333M1.33398 7.99992L8.00065 11.3333L14.6673 7.99992M8.00065 1.33325L1.33398 4.66659L8.00065 7.99992L14.6673 4.66659L8.00065 1.33325Z" stroke="#09090B" strokeLinecap="round" strokeLinejoin="round" />
    </g>
    <defs>
...
export const TrashIcon = () => (
  <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 3.99992H14M12.6667 3.99992V13.3333C12.6667 13.9999 12 14.6666 11.3333 14.6666H4.66667C4 14.6666 3.33333 13.9999 3.33333 13.3333V3.99992M5.33333 3.99992V2.66659C5.33333 1.99992 6 1.33325 6.66667 1.33325H9.33333C10 1.33325 10.6667 1.99992 10.6667 2.66659V3.99992M6.66667 7.33325V11.3333M9.33333 7.33325V11.3333" stroke="#09090B" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
