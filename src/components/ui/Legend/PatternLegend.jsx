    ...
    <div className='ml-4'>
      <svg width="203" height="112" viewBox="0 0 203 112" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g clipPath="url(#clip0_2140_57350)">
          <rect x="1" y="1" width="27" height="18" fill='url(#patternDots)' stroke={"#3E5E5F"} strokeWidth="0.5"/>
        </g>
        <text x="49" y="15" fill="#0F172A" fontSize="16">0 - 25%</text>

        <g clipPath="url(#clip1_2140_57350)">
          <rect x="1" y="76" width="27" height="18" fill='url(#patternStripes)' stroke={"#3E5E5F"} strokeWidth="0.5"/>
        </g>
        <text x="49" y="40" fill="#0F172A" fontSize="16">25 - 50%</text>

        <g clipPath="url(#clip2_2140_57350)">
          <rect x="1" y="51" width="27" height="18" fill='url(#patternGrid)' stroke={"#3E5E5F"} strokeWidth="0.5" />
        </g>
        <text x="49" y="65" fill="#0F172A" fontSize="16">50 - 75%</text>

        <g clipPath="url(#clip3_2140_57350)">
          <rect x="1" y="25" width="27" height="18" fill='url(#patternZigzag)' stroke={"#3E5E5F"} strokeWidth="0.5"/>
        </g>
